...
Route::group(['middleware' => ['role:admin', 'permission:create post|edit post|delete post']], function () {
    //
});
Route::group(['middleware' => ['role:author', 'permission:create post']], function () {
